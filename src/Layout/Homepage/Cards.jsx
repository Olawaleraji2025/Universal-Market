...
export const Cards = () => (
    ...
    <div className="grid md:grid-cols-3 mb-8 gap-8 text-center">
      ...
      <div className="market-info-card">
        ...
        <span>Clear product information and straightforward communication..</span>
      </div>

      <div className="market-info-card">
        <div className="bg-[#60e9c2] p-4 rounded-xl">
        <TbCreditCard className="trust-icons"/>
        </div>
        <p> Flexible Purchase</p>
        <span>Connect with us directly to confirm availability and complete your purchase.</span>
      </div>
    </div>
          </section>
    );
